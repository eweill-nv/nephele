...
output "x8a100_40g_ids" {
  value = module.instances_x8a100_40g.instance_ids
}

resource "local_file" "compute_node_ids" {
  filename = "../../compute_node_ids"
  content = module.instances_x8a100_40g.instance_ids
}
